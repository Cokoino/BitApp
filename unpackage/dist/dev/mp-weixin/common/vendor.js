...
/* 4 */
/*!********************************************************!*\
  !*** C:/Users/Administrator/Desktop/newApp/pages.json ***!
  \********************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 17 */
/*!*************************************************************!*\
  !*** C:/Users/Administrator/Desktop/newApp/JS/bluetooth.js ***!
  \*************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
Bluetooth = /*#__PURE__*/function () {
    ...
    //链接成功后，保存此deviceId，下一步onBLEConnectionStateChange还需要用到此deviceId
      ...
      uni.createBLEConnection({
        ...
        success: function success(res) {
          ...
          setTimeout(function () {//必要等待1秒以上，否则getBLEDeviceServices为空数据
        ...
        success: function success(res) {
          ...
          for (var s = 0; s < res.services.length; s++) {
            ...
            self.BtServiceId.MicrobitServiceId === res.services[s].uuid) {
              self.serviceId = res.services[s].uuid; //保存串口ServiceId
              console.log("获取设备串口ServiceId成功:" + res.services[s].uuid);
  ...
  }, { key: "writeBLECharacteristicValue", value: function writeBLECharacteristicValue(binaryData) {
      var deviceId = this.deviceId;
      var serviceId = this.serviceId;
      var characteristicId = this.writeId;

      var self = this;
      // 向蓝牙设备发送3个16进制数据: 0xf0, binaryData, 0x0f
      var buffer = new ArrayBuffer(3); //ArrayBuffer是字节数组
      var dataView = new DataView(buffer); //通过DataView对象来操作字节数组
      dataView.setUint8(0, 0xf0);
      dataView.setUint8(1, binaryData);
      dataView.setUint8(2, 0x0f);
